...
func printUsage() {
	...
	fmt.Fprintf(os.Stderr, "█▄▀ █▄█ █ ▀ █ █▄█ █ █\n\n")
	fmt.Fprintf(os.Stderr, "domux - per-worktree TODO TUI for tmux\n\n")
	fmt.Fprintf(os.Stderr, "Usage:\n")
	fmt.Fprintf(os.Stderr, "  domux              Start the task TUI\n")
	...
	fmt.Fprintf(os.Stderr, "  domux sessions     Launch session picker\n")
	...
	fmt.Fprintf(os.Stderr, "  domux install      Preview tmux/Claude integration install\n")
