...
func printUsage() {
	...
	fmt.Fprintf(os.Stderr, "  domux usage        Show Claude and Codex subscription usage\n\n")
	...
	fmt.Fprintf(os.Stderr, "Artboards:\n")
	fmt.Fprintf(os.Stderr, "  domux artboards init \"<title>\"  Register/resume a review group for this session\n")
	fmt.Fprintf(os.Stderr, "  domux artboards list             List groups (--all, --archived, --json)\n")
	fmt.Fprintf(os.Stderr, "  domux artboards archive KEY      Close a group (activate to reopen)\n")
	fmt.Fprintf(os.Stderr, "  domux artboards status           One-shot check of the local server\n")
	fmt.Fprintf(os.Stderr, "  domux artboards open             Open the artboards page in the browser\n")
	fmt.Fprintf(os.Stderr, "  domux artboards restart          Reload the artboards LaunchAgent\n\n")
