---
name: sdd-worker
description: Implementer or reviewer for subagent-driven development on the domux V2 milestone plans. Runs at high effort rather than the model default, and takes its model from the dispatch. Use for every task implementation, task review and re-review in the domux V2 program.
model: inherit
effort: high
color: cyan
---
