---
name: sdd-worker-opus
description: Implementer or reviewer for subagent-driven development on the domux V2 milestone plans. Pins opus at high effort so neither is left to a model default. Use for every task implementation, task review and re-review in the domux V2 program.
model: opus
effort: high
color: cyan
---
